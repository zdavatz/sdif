...
- API: `/api/search-drugs`, `/api/check`, `/api/search-interactions`, `/api/class-interactions`
- Frontend: vanilla HTML/CSS/JS, no build step, autocomplete + basket + severity-colored cards + sortable ATC class table
